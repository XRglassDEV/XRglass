...
const workflowStages = [
  {
    title: "Sense",
    description: "Continuous monitoring across XRPL, DEX, NFT, sanction, and behavioural feeds.",
    time: "sub-second ingest",
  },
  {
    title: "Interpret",
    description: "AI narratives and heuristics summarise risk posture for every wallet and project.",
    time: "<120ms inference",
  },
  {
    title: "Decide",
    description: "Policy automations escalate to the right teams with approval routing and evidence.",
    time: "0 manual triage",
  },
  {
    title: "Assure",
    description: "Export branded attestations and compliance packets for partners and regulators.",
    time: "one-click",
  },
];
    ...
    <div className="space-y-28">
        ...
        <div className="grid gap-12 lg:grid-cols-[1.35fr_1fr] lg:items-end">
          <div className="space-y-8">
            ...
            <p className="max-w-2xl text-balance text-base text-white/70 sm:text-lg">
              XRglass fuses AI narratives, behavioural analytics, and programmable automations into a single pane. See risk, orchestrate responses, and deliver regulator-grade evidence in minutes.
            </p>
            ...
            <div className="relative space-y-8">
              <div>
                ...
                <p className="mt-2 text-sm text-white/60">
                  Predictive heuristics surface behavioural anomalies before funds move. Tailored to your risk thresholds.
                </p>
              </div>
      ...
      <section id="platform" className="space-y-12">
        <div className="grid gap-6 text-center">
          ...
          <p className="mx-auto max-w-2xl text-balance text-sm text-white/60 sm:text-base">
            Every layer is co-designed with exchanges, institutions, and regulators to deliver uncompromising clarity across the XRPL.
          </p>
        </div>
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {platformPillars.map((pillar) => (
            <div key={pillar.title} className="glass-panel--soft shadow-ring flex h-full flex-col gap-6 p-6">
      ...
      <section id="capabilities" className="space-y-12">
        <div className="grid gap-6 text-center">
          ...
          <p className="mx-auto max-w-2xl text-balance text-sm text-white/60 sm:text-base">
            From compliance to investigations, XRglass aligns every stakeholder with a single version of truth.
          </p>
        </div>
      ...
      <section id="stories" className="space-y-12">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {testimonials.map((testimonial) => (
            <div key={testimonial.author} className="glass-panel--soft flex h-full flex-col gap-6 p-6">
      ...
      <section id="security" className="space-y-12">
        <div className="grid gap-6 text-center">
          ...
          <p className="mx-auto max-w-2xl text-balance text-sm text-white/60 sm:text-base">
            Dual-region deployments, sovereign options, and a dedicated trust science desk ensure your regulators stay confident and informed.
          </p>
        </div>
        <div className="glass-panel--soft grid gap-6 px-6 py-10 sm:grid-cols-3 sm:px-10">
          <div className="space-y-3">
            <p className="text-xs font-semibold uppercase tracking-[0.4em] text-white/50">Certifications</p>
            <p className="text-sm text-white/70">SOC 2 Type II, ISO 27001, GDPR, and MiCA-aligned controls with external attestations.</p>
          </div>
          <div className="space-y-3">
            <p className="text-xs font-semibold uppercase tracking-[0.4em] text-white/50">Residency</p>
            <p className="text-sm text-white/70">Choose EU or US clusters, with sovereign deployments for central banks and regulatory sandboxes.</p>
          </div>
          <div className="space-y-3">
            <p className="text-xs font-semibold uppercase tracking-[0.4em] text-white/50">Response</p>
            <p className="text-sm text-white/70">24/7 encrypted support, executive incident briefings, and <span className="text-gradient">15-minute</span> SLA activations.</p>
          </div>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden rounded-[40px] border border-white/10 bg-gradient-to-br from-slate-900/80 via-slate-900/60 to-slate-900/40 px-6 py-16 text-center shadow-[0_28px_80px_rgba(10,18,40,0.5)] sm:px-12">
        ...
        <div className="relative space-y-6">
          ...
          <p className="mx-auto max-w-2xl text-balance text-sm text-white/60 sm:text-base">
            Join a curated collective of exchanges, institutions, and agencies shaping the future of XRPL trust. Our concierge team will choreograph a bespoke rollout for your organisation.
          </p>
